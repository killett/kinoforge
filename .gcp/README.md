...
- Project: `<GCP_PROJECT>`
- Operator account: `retool4251@proton.me`
...
Operator account: `retool4251@proton.me` (also authenticated; switch with
`gcloud config set account retool4251@proton.me`).
