...
## Phase
Execution started. Tasks 1–18 complete. Phases 1–5 complete.
...
## Single next action
Task 20a: ComfyUIEngine — implement `src/kinoforge/engines/comfyui/__init__.py` + node installer + tests.
