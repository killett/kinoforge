...
**STATUS INDEX (current as of 2026-09-10. Provenance, newest first: U25 fixed 2026-09-10
...
Thirty-one items, U1-U31. **Twenty-four are fixed** (U1, U2, U3, U4, U7, U8, U9, U11, U12, U14,
U15, U16, U17, U18, U20, U21, U22, U23, U25, U26, U27, U28, U29, U30), **two are partly fixed**
(U5, U10), **five are open** (U6, U13, U19, U24, U31). **U31 was filed 2026-09-10** while measuring
...
**Do U19 or U6 — in that order, and read the row before starting.** U19 needs a live RIFE
T4 proof (~$0.03) after a small in-pod change; U6 is the biggest — fixing `deploy`'s empty `RenderedProvision` moves the launch
...
~~Do U1, U6, U19, U24 or U25~~ — U1 (`33a31586`) and U25 (`602c3f7a`) were both fixed
2026-09-10.
